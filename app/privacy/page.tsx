            ...
            <div className="space-y-4">
              <div className="border-l-4 border-green-400 pl-4">
                ...
                <p className="text-gray-600">
                  When you mark servers as favorites, this information is synced
                  to our cloud service to ensure availability across your
                  devices.
                </p>
              </div>
              <div className="border-l-4 border-blue-400 pl-4">
                ...
                <p className="text-gray-600">Save at localstorage.</p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    We do <strong>not</strong> collect personal identity data
                    (such as your name, email, or IP address), unless you
                    explicitly sign in to a linked cloud account.
                  </p>
                </div>
                <div className="flex items-start">
                  <span className="text-red-500 mr-2 mt-1">•</span>
                  <p className="text-gray-700">
                    We do <strong>not</strong> share your data with any
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                ...
                <p className="text-gray-700">
                  All synced data is stored securely and is accessible only to
