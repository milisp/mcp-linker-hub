    ...
    <section className="px-6 py-12 max-w-6xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          Stop wasting time with complex configurations. Get your MCP servers
          running in seconds.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm rounded-xl p-6 border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Install and configure MCP servers in just two clicks. No terminal
        ...
        <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm rounded-xl p-6 border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Works with Claude Desktop, Cursor, Windsurf, VS Code, Cline, neovim,
            and more editors.
          </p>
        </div>
        ...
        <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm rounded-xl p-6 border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Built-in server management, updates, and configuration. Everything
