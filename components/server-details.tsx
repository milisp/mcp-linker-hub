...
export function ServerDetails({ server }: ServerDetailsProps) {
  ...
  const copyServerUrl = () => {
    navigator.clipboard.writeText(`https://mcp-server-hub.vercel.app/server/${server.id}`)
    setCopied(true)
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Button variant="outline" size="icon" className="rounded-full" onClick={copyServerUrl}>
          ...
          <Tabs defaultValue="about">
            ...
            <TabsContent value="about" className="mt-4 prose dark:prose-invert max-w-none">
            ...
            <CardContent className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col items-center p-3 bg-muted/50 rounded-lg">
                  ...
                  <div className="font-medium">{server.githubStars.toLocaleString()}</div>
                  <div className="text-xs text-muted-foreground">GitHub Stars</div>
                </div>
                <div className="flex flex-col items-center p-3 bg-muted/50 rounded-lg">
                  <Download className="h-5 w-5 mb-1" />
                  <div className="font-medium">{server.downloads.toLocaleString()}</div>
              ...
              <div className="pt-4 border-t">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <Link href="/server/2" className="text-sm font-medium hover:underline">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <Link href="/server/3" className="text-sm font-medium hover:underline">
                        MySQL MCP Server
                      </Link>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <Link href="/server/4" className="text-sm font-medium hover:underline">
                        MongoDB MCP Server
                      </Link>
