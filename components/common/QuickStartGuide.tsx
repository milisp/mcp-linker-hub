          ...
          {[
            {
              step: "1",
              title: "Select Server",
              desc: "Choose an MCP server from our curated list",
              icon: "🔍",
            },
            {
              step: "2",
              title: "View Config",
              desc: "Click Get to preview the server configuration",
              icon: "👁️",
            },
            {
              step: "3",
              title: "Add Integration",
              desc: "Click Add to integrate with your MCP client",
              icon: "➕",
            },
            {
              step: "4",
              title: "Manage",
              desc: "Access from favorites or history panel",
              icon: "⚡",
            },
          ].map((step, index) => (
